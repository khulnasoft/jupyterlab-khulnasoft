...
// @generated from file exa/khulnasoft_common_pb/khulnasoft_common.proto (package exa.khulnasoft_common_pb, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from enum exa.khulnasoft_common_pb.ExperimentKey
 */
...
proto3.util.setEnumType(ExperimentKey, 'exa.khulnasoft_common_pb.ExperimentKey', [
 ...
 *
 * @generated from enum exa.khulnasoft_common_pb.AuthSource
 */
export enum AuthSource {
  /**
   * @generated from enum value: AUTH_SOURCE_KHULNASOFT = 0;
   */
  KHULNASOFT = 0
}
// Retrieve enum metadata with: proto3.getEnumType(AuthSource)
proto3.util.setEnumType(AuthSource, 'exa.khulnasoft_common_pb.AuthSource', [
  { no: 0, name: 'AUTH_SOURCE_KHULNASOFT' }
]);

/**
 * @generated from enum exa.khulnasoft_common_pb.EventType
 */
export enum EventType {
  ...
  /**
   * @generated from enum value: EVENT_TYPE_ENABLE_KHULNASOFT = 1;
   */
  ENABLE_KHULNASOFT = 1,

  /**
   * @generated from enum value: EVENT_TYPE_DISABLE_KHULNASOFT = 2;
   */
  DISABLE_KHULNASOFT = 2,
...
proto3.util.setEnumType(EventType, 'exa.khulnasoft_common_pb.EventType', [
  { no: 0, name: 'EVENT_TYPE_UNSPECIFIED' },
  { no: 1, name: 'EVENT_TYPE_ENABLE_KHULNASOFT' },
  { no: 2, name: 'EVENT_TYPE_DISABLE_KHULNASOFT' },
  { no: 3, name: 'EVENT_TYPE_SHOW_PREVIOUS_COMPLETION' },
  { no: 4, name: 'EVENT_TYPE_SHOW_NEXT_COMPLETION' }
]);

/**
 * @generated from enum exa.khulnasoft_common_pb.CompletionSource
 */
...
proto3.util.setEnumType(
  CompletionSource,
  'exa.khulnasoft_common_pb.CompletionSource',
  [
 ...
 *
 * @generated from enum exa.khulnasoft_common_pb.Language
 */
...
proto3.util.setEnumType(Language, 'exa.khulnasoft_common_pb.Language', [
 ...
 *
 * @generated from message exa.khulnasoft_common_pb.Completion
 */
export class Completion extends Message<Completion> {
  ...
  static readonly typeName = 'exa.khulnasoft_common_pb.Completion';
 ...
 *
 * @generated from message exa.khulnasoft_common_pb.Metadata
 */
export class Metadata extends Message<Metadata> {
   ...
   *
   * @generated from field: exa.khulnasoft_common_pb.AuthSource auth_source = 15;
   */
  authSource = AuthSource.KHULNASOFT;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = 'exa.khulnasoft_common_pb.Metadata';
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message exa.khulnasoft_common_pb.EditorOptions
 */
export class EditorOptions extends Message<EditorOptions> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = 'exa.khulnasoft_common_pb.EditorOptions';
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message exa.khulnasoft_common_pb.Event
 */
export class Event extends Message<Event> {
  /**
   * @generated from field: exa.khulnasoft_common_pb.EventType event_type = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = 'exa.khulnasoft_common_pb.Event';
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    {
      no: 1,
      name: 'event_type',
