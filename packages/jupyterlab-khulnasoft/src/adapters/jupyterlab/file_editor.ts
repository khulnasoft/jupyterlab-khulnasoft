...
export class FileEditorAdapter extends JupyterLabWidgetAdapter {
  ...
  protected current_completion_connector: KhulnasoftConnector & {
  ...
  connect_completion() {
    this.current_completion_connector = new KhulnasoftConnector({
    ...
    this.registerKhulnasoftModules(handler, this.editor.editor, this.state);
  }
