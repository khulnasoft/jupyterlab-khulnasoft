...
export class DocumentConnectionManager {
  ...
  constructor(options: DocumentConnectionManager.IOptions) {
    ...
    this.khulnasoft_status_model = options.khulnasoft_status_model;
...
export namespace DocumentConnectionManager {
  ...
  export function solve_uris(
    ...
    return {
      ...
      server: URLExt.join('ws://jupyter-khulnasoft', language),
      socket: URLExt.join(
        wsBase,
  ...
  export async function connection(
    ...
    if (connection == null) {
      ...
      const connection = new LSPConnection({
        ...
        rootUri: uris.base,
        khulnasoft_status_model: khulnasoft_status_model
      });
