...
from .locator import KhulnasoftLocator
from .onboarding import KhulnasoftOnboardingHandler
...
class LanguageServerWebSocketHandler(WebSocketMixin, WebSocketHandler, BaseHandler):
    ...
    def initialize(self, *args, **kwargs):
        ...
        self.onboarding_handler = KhulnasoftOnboardingHandler()
...
class KhulnasoftInstalledHandler(BaseHandler):
    """
    Reports if Khulnasoft is installed
    """

    def initialize(self, *args, **kwargs):
        super().initialize(kwargs["manager"])
        self.locator = KhulnasoftLocator()

    def get(self):
        exists, _ = self.locator.check_if_khulnasoft_installed()
...
def add_handlers(nbapp):
    ...
    nbapp.web_app.add_handlers(
        ...
        [
            ...
            (ujoin(lsp_url, "khulnasoft_installed"), KhulnasoftInstalledHandler, opts),
        ],
    )
